...
- **Flexible Group Size Control** - Configure minimum group size requirement (default: 10 for raid groups)
...
- **Enabled:** No (automatically disabled on login)
- **Combat Only:** Yes
- **Minimum Group Size:** 10
- **Tea Threshold:** 60% mana
- **Major Mana Potion Threshold:** 40% mana
- **Major Rejuvenation Potion Threshold:** 50% health
- **Healthstone Threshold:** 30% health
- **Flask Threshold:** 20% mana
